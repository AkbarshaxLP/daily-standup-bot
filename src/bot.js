...
function createBot() {
  ...
  bot.command('testreport', (ctx) => {
    ...
    const fakeSnapshot = {
      ...
      callEndTime: now,
      participants: [
        { userId: 111, name: 'Иван Иванов', username: 'ivan_dev', joinTime: now - 22 * 60 * 1000, leaveTime: now, spoke: true },
        { userId: 222, name: 'Мария Петрова', username: null, joinTime: now - 18 * 60 * 1000, leaveTime: now, spoke: false },
      ],
      absent: [
